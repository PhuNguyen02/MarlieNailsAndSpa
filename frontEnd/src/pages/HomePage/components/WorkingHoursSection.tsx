  ...
  return (
    <Box
      sx={{
        py: { xs: 8, md: 12 },
        position: 'relative',
        background: 'linear-gradient(180deg, #fffcf9 0%, #ffffff 50%, #f7f0e8 100%)',
        overflow: 'hidden',
        '&::before': {
          content: '""',
          position: 'absolute',
                  ...
                  >
                    ...
                    <Box sx={{ flex: 1 }}>
                      ...
                      <Typography
                        variant="body2"
                        sx={{
                          color: schedule.day.includes('Nghỉ') ? 'text.secondary' : 'primary.dark',
          ...
          <Grid item xs={12} md={4}>
            <Paper
              ...
              sx={{
                ...
                backgroundImage: 'linear-gradient(135deg, #d4af8c 0%, #b8956f 100%)',
                p: { xs: 4, md: 5 },
                borderRadius: 4,
                textAlign: 'center',
                display: 'flex',
