...
const PricingSection = ({ data }: { data?: HomepageSection }) => {
  ...
  const findService = (namePart: string, categories: ServiceItem[][]) => {
    for (const cat of categories) {
      const found = cat.find((s) => s.name.toLowerCase().includes(namePart.toLowerCase()));
                          ...
                          <Box
                            sx={{
                              ...
                              backgroundColor: isFeatured
                                ...
                                : 'rgba(0, 0, 0, 0.02)',
                              border: isFeatured ? '1px dashed rgba(212, 175, 140, 0.5)' : 'none',
                              minHeight: '80px',
                              display: 'flex',
                              alignItems: 'center',
                            ...
                            ...(isFeatured
                              ? {
                                  ...
                                  '&:hover': {
                                    ...
                                    boxShadow: '0 12px 25px rgba(212, 175, 140, 0.4)',
                                  },
                                }
                              : {
                                  ...
                                  '&:hover': {
                                    ...
                                    backgroundColor: 'rgba(212, 175, 140, 0.05)',
                                    transform: 'translateY(-4px)',
                                  },
                                }),
                            py: 2,
